...
# http://www.opensource.apple.com/source/IOHIDFamily/
# IOHIDFamily-86.1/IOHIDSystem/IOKit/hidsystem/ev_keymap.h
...
class PyKeyboard(PyKeyboardMeta):
    ...
    def _press_normal_key(self, key, down):
        try:
            if self.is_char_shifted(key):
                ...
                e = CGEventCreateKeyboardEvent  # PEP8 E501 purpose
                event = e(None, character_translate_table['shift'], down)
    ...
    def _press_special_key(self, key, down):
        ...
        11045814/emulate-media-key-press-on-mac
        """
